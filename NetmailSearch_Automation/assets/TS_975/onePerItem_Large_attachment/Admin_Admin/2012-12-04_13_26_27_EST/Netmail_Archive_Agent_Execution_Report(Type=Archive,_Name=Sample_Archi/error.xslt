...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxml="urn:schemas-microsoft-com:xslt">
  ...
  <xsl:template name="printHeader">
    ...
    <caption>
      <a name="{$account}">
        <h1>
          <xsl:value-of select="$displayname"/> - Error Summary
        </h1>
      </a>
      <a href="#Top">Home</a>
    </caption>
  ...
  <xsl:template name="printErrors">
    ...
    <xsl:for-each select="$records">
      ...
      <tr>
        ...
        <td>
          <small>
            <xsl:value-of select="messagecreationdate" />
          </small>
        </td>
        <td>
          <small>
    ...
    <html>
      ...
      <body>
        ...
        <xsl:choose>
          ...
          <xsl:otherwise>
            <h3>There were no errors encountered during execution of this trigger.</h3>
          </xsl:otherwise>
        </xsl:choose>
      </body>
    </html>
