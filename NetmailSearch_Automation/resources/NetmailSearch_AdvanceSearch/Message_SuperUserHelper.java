...
/**
 * Script Name   : <b>Message_SuperUser</b><br>
 * Generated     : <b>2014/07/28 4:57:33 PM</b><br>
 ...
 */
public abstract class Message_SuperUserHelper extends utilities.MySuperHelper
{
	/**
	...
	/**
	 * activeTabBody: with default state.
	 *		.className : RegularExpression((\s)*x-panel x-panel-noborder$)
	 * 		.class : Html.DIV
	 */
	protected GuiTestObject html_activeTabBody() 
	{
		return new GuiTestObject(
                        getMappedTestObject("html_activeTabBody"));
	}
	/**
	 * activeTabBody: with specific test context and state.
	 *		.className : RegularExpression((\s)*x-panel x-panel-noborder$)
	 * 		.class : Html.DIV
	 */
	protected GuiTestObject html_activeTabBody(TestObject anchor, long flags) 
	{
		return new GuiTestObject(
                        getMappedTestObject("html_activeTabBody"), anchor, flags);
	}
	
	/**
	 * closeAdvanceSearch: with default state.
	 *		.className : x-tool x-tool-close
	 * 		.class : Html.DIV
	 * 		.classIndex : 0
	 */
	protected GuiTestObject html_closeAdvanceSearch() 
	{
		return new GuiTestObject(
                        getMappedTestObject("html_closeAdvanceSearch"));
	}
	/**
	 * closeAdvanceSearch: with specific test context and state.
	 *		.className : x-tool x-tool-close
	 * 		.class : Html.DIV
	 * 		.classIndex : 0
	 */
	protected GuiTestObject html_closeAdvanceSearch(TestObject anchor, long flags) 
	{
		return new GuiTestObject(
                        getMappedTestObject("html_closeAdvanceSearch"), anchor, flags);
	}
	...
	/**
	 * toolTip: with default state.
	 *		.className : x-tip-body
	 * 		.class : Html.DIV
	 * 		.contentText : RegularExpression(.*Invalid date.*)
	 * 		.classIndex : 0
	 */
	protected GuiTestObject html_toolTip() 
	{
		return new GuiTestObject(
                        getMappedTestObject("html_toolTip"));
	}
	/**
	 * toolTip: with specific test context and state.
	 *		.className : x-tip-body
	 * 		.class : Html.DIV
	 * 		.contentText : RegularExpression(.*Invalid date.*)
	 * 		.classIndex : 0
	 */
	protected GuiTestObject html_toolTip(TestObject anchor, long flags) 
	{
		return new GuiTestObject(
                        getMappedTestObject("html_toolTip"), anchor, flags);
	}
	 ...
	 */
	protected TextGuiTestObject text_rcvDate2_2() 
	{
		return new TextGuiTestObject(
                        getMappedTestObject("text_rcvDate2_2"));
	}
	/**
	 * rcvDate2: with specific test context and state.
	 *		.text : 
	 ...
	 * 		class : x-form-text x-form-field x-form-invalid
	 */
	protected TextGuiTestObject text_rcvDate2_2(TestObject anchor, long flags) 
	{
		return new TextGuiTestObject(
                        getMappedTestObject("text_rcvDate2_2"), anchor, flags);
	}
	...
	/**
	 * Locate and return the verification point InvalidRcvDate1 object in the SUT.
	 */
	protected IFtVerificationPoint InvalidRcvDate1VP() 
	{
		return vp("InvalidRcvDate1");
	}
	protected IFtVerificationPoint InvalidRcvDate1VP(TestObject anchor)
	{
		return vp("InvalidRcvDate1", anchor);
	}
	
	/**
	 * Locate and return the verification point InvalidRcvDate2 object in the SUT.
	 */
	protected IFtVerificationPoint InvalidRcvDate2VP() 
	{
		return vp("InvalidRcvDate2");
	}
	protected IFtVerificationPoint InvalidRcvDate2VP(TestObject anchor)
	{
		return vp("InvalidRcvDate2", anchor);
	}
	
	/**
	 * Locate and return the verification point mbInvalidSendDate2 object in the SUT.
	 */
	protected IFtVerificationPoint mbInvalidSendDate2VP() 
	{
		return vp("mbInvalidSendDate2");
	}
	protected IFtVerificationPoint mbInvalidSendDate2VP(TestObject anchor)
	{
		return vp("mbInvalidSendDate2", anchor);
	}
	
	/**
	 * Locate and return the verification point mbInvalidSentDate1 object in the SUT.
	 */
	protected IFtVerificationPoint mbInvalidSentDate1VP() 
	{
		return vp("mbInvalidSentDate1");
	}
	protected IFtVerificationPoint mbInvalidSentDate1VP(TestObject anchor)
	{
		return vp("mbInvalidSentDate1", anchor);
	}
	...
	/**
	 * Locate and return the verification point visibleToolTip object in the SUT.
	 */
	protected IFtVerificationPoint visibleToolTipVP() 
	{
		return vp("visibleToolTip");
	}
	protected IFtVerificationPoint visibleToolTipVP(TestObject anchor)
	{
		return vp("visibleToolTip", anchor);
	}
	
	

	protected Message_SuperUserHelper()
	{
		setScriptName("NetmailSearch_AdvanceSearch.Message_SuperUser");
	}
