...
public class NetmailLogin extends NetmailLoginHelper
{
	...
	private void performLogin(String username, String password){
		...
		try{
			vpManual("NumOfLanguageOption", 4, languages.length).performTest();
...
//			vpManual("FifthLanguageOption", "Magyar", languages[4].getProperty(".text")).performTest();
		}catch(Exception e){
			logError("failed language verification");
			logInfo(e.getMessage());
		}
		msg = "LOGIN: username = < %s >, password = < %s >";
